...
void CGI::run(std::string method, std::string bodyContent, int contentLength)
{
    ...
    // 设置 CONTENT_TYPE 环境变量
    CGI::put2env("CONTENT_TYPE=application/x-www-form-urlencoded");
    CGI::put2env("HTTP_CONTENT_TYPE=application/x-www-form-urlencoded");
